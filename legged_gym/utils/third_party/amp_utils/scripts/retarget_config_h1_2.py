...
URDF_FILENAME = f"{AMP_UTILS_DIR}/models/h1_2/h1_2_simplified.urdf"
OUTPUT_DIR = f"{AMP_UTILS_DIR}/motion_files/mocap_motions_h1_2/"

REF_POS_SCALE = 1.0 # 缩放系数,如果遇到关节限位异常，尝试将此数变小
INIT_POS = np.array([0, 0, 1.0]) # h1_2
...
DEFAULT_JOINT_POSE = np.array([0., 0., -0.16,
                               0.36, -0.2, 0.,
                               0., 0., -0.16,
                               0.36, -0.2, 0.,
                               0., 0.4, 0.,
